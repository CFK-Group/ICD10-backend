...
CREATE TABLE `canal` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nGrilla` varchar(45) NOT NULL COMMENT 'Número del canal en la grilla de TV',
  `nTB` varchar(45) NOT NULL COMMENT 'Número de Traffic & Billing',
  `nNetwork` varchar(45) NOT NULL COMMENT 'Número de network',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
